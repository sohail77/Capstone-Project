...
/**
 * Manages "Authentication" to Patternizer's backend service.  The SyncAdapter framework
 ...
 */
public class PatternizerAuthenticator extends AbstractAccountAuthenticator {

    public PatternizerAuthenticator(Context context) {
        super(context);
    }
